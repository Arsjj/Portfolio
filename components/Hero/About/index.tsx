...
const Animation = () => {
    ...
    return (
        <div onClick={handleChecked} className='flex relative py-10 max-w-3xl '>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className='cursor-pointer' width="100%" height="fit" viewBox="0 0 1036 300" shapeRendering="geometricPrecision" textRendering="geometricPrecision">
                <g id="fireCircles">
                ...
                <g id="container" style={{ "isolation": "isolate" }}>
                    ...
                    <path id="containerBox" d="M250,283.5c19.64.515,28.781-2.462,41.5-14l11.5-12c9.98-7.571,16.62-9.831,30.5-10h127.5c11.484-.409,17.715,1.899,28.5,10l13,12c9.098,9.05,15.207,11.924,27.5,14h327.5v-2h66c11.148-3.896,16.743-6.824,25-14L1021,195c5.15-7.217,7.68-11.513,11-20l.5-67h2v-41h-1.5v-25.25-25.25c.04-9.12834-2.76-12.34415-13-14.5h-53-793.5l-7.529-.63164C227.189,8.8461,272.536,56.6375,285,116.5l-2.75.5c12.64,101.955-49.038,162.651-139.75,166c0,0,0,.500001,0,.500001v-2.000001v1.999998L250,283.5Z" transform="translate(0 0.000002)" stroke="rgb(212 175 55)"  fillOpacity="0.29" />
                ...
                <foreignObject id="detailsContainer" x="8" y="" width="680" height="350" transform="translate(300 30)">
