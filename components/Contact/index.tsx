        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-tertiary py-4 px-6 border border-white/25 shadow-[0_0_12px_rgba(255,255,255,0.05)] focus:border-white/70  text-white duration-300 rounded-lg outline-none font-medium"
            />
          </label>
          <label className="flex flex-col">
            ...
            <input
              ...
              value={form.email}
              onChange={handleChange}
              className="bg-tertiary py-4 px-6 border border-white/25 shadow-[0_0_12px_rgba(255,255,255,0.05)] focus:border-white/70 duration-300 text-white rounded-lg outline-none font-medium"
            />
          </label>
          <label className="flex flex-col">
